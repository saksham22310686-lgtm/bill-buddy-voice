...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "gradient-primary text-primary-foreground hover:scale-105 glow-primary",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:scale-105",
        outline: "glass border-0 hover:glow-primary hover:scale-105",
        secondary: "gradient-secondary text-primary-foreground hover:scale-105 glow-secondary",
        ghost: "hover:glass hover:scale-105",
        link: "text-primary underline-offset-4 hover:underline",
        voice: "gradient-primary text-primary-foreground hover:scale-110 glow-primary animate-pulse-glow rounded-full aspect-square",
        success: "gradient-success text-primary-foreground hover:scale-105",
      },
      size: {
